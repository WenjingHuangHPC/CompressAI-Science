...
std::vector<torch::Tensor> encode_with_indexes(
    ...
    return encode_with_indexes_cuda(symbols_bxn, indexes_bxn, cdfs_mxl, cdf_sizes_m, offsets_m);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("encode_with_indexes", &encode_with_indexes_cuda, "GPU rANS encode_with_indexes");
    m.def("decode_with_indexes", &decode_with_indexes_cuda, "GPU rANS decode_with_indexes");
}
